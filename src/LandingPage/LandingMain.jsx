...
export default function LandingMain() {
  ...
  return (
    <main className='min-h-full bg-[var(--primary-white)] dark:bg-[var(--secondary)] dark:text-[var(--primary)]  '>
      ...
      <section
        id='overview'
        className=' flex flex-col items-center justify-center md:flex-row gap-9 py-48 px-10 md:px-32'
      >
      ...
      <section
        id='getting-started'
        className='scroll-mt-32 my-32   bg-[var(--white)] flex flex-col items-center justify-center '
      >
        <h2 className='text-3xl mb-5 '>Get Started</h2>
        <div className='grid   g items-center justify-center'>
          <h2>
            Check out our{' '}
            <a
              className='text-[var(--third-color)] hover:text-[var(--third-color-600)]'
              href='https://github.com/oslabs-beta/Prism'
            >
              Github page
            </a>{' '}
            and follow the Read Me file.
          </h2>
        </div>
      </section>
