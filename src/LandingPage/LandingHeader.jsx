...
// import prismlogodarkmode from '../assets/';
    ...
    <header className="bg-[var(--secondary)] px-10 md:px-32  text-[var(--primary)] justify-center items-center relative py-1 top-0 left-0 min-w-full font-bold sticky ">
      <div className="h-24 flex items-center justify-between mx-auto  ">
        ...
        <div
          ...
          className=" cursor-pointer md:hidden w-9 h-9  my-auto mx-auto bg-white  hover:text-[var(--secondary)] hover:bg-[var(--primary)] rounded-sm flex justify-center items-center  "
        >
          {isOpen ? (
        ...
        >
          {Links.map((link) => (
            <li
              ...
              className=" p-3 cursor-pointer bg-white  hover:text-[var(--secondary)] hover:bg-[var(--primary)] rounded-sm flex justify-center items-center"
            >
              {link.name}
            </li>
          ))}
