    ...
    <div className='flex '>
      {theme === 'dark' ? (
        ...
        <div className='flex items-center justify-center gap-3'>
          ...
          <button
            onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
            className='items-center bg-transparent justify-center gap-2 text-[var(--primary)]  hover:bg-[var(--primary)] hover:text-[var(--secondary)] rounded-full py-2 px-2 scale-125'
          >
            <MdDarkMode />
          </button>
        </div>
